...
if("FALSE" STREQUAL "TRUE")
  set(robot_vision_SOURCE_PREFIX /home/cidi/dl/3dobject/keras-yolo3/cv_ws/src/robot_vision)
  set(robot_vision_DEVEL_PREFIX /home/cidi/dl/3dobject/keras-yolo3/devel_isolated/robot_vision)
  ...
  set(robot_vision_INSTALL_PREFIX /home/cidi/dl/3dobject/keras-yolo3)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'robot_vision' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'cch <cch@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'robot_vision' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cidi/dl/3dobject/keras-yolo3/${idir}'.  Ask the maintainer 'cch <cch@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/cidi/dl/3dobject/keras-yolo3/lib;/home/cidi/apollodds/dds/third_party/apollo-platform/ros/install/ros_x86_64/lib)
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${robot_vision_dep}_FOUND)
      find_package(${robot_vision_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${robot_vision_dep} REQUIRED ${depend_list})
  endif()
  ...
  list(APPEND robot_vision_EXPORTED_TARGETS ${${robot_vision_dep}_EXPORTED_TARGETS})
endforeach()
