...
from yolo3.modelmerge import preprocess_true_boxes, yolo_body, tiny_yolo_body, yolo_loss, yolo_19_body
...
#    input_shape = (416,416) # multiple of 32, hw
    ...
    if is_tiny_version:
        model = create_tiny_model(input_shape, anchors, num_classes,
            freeze_body=2, weights_path='logs/000/ep003-loss53.589-val_loss49.487.h5') #model_data/tiny_yolo_weights.h5')
    else:
        model = create_model(input_shape, anchors, num_classes,
            freeze_body=0, load_pretrained=True, weights_path='logs/000/ep066-loss43.171-val_loss42.802.h5')
...
def create_tiny_model(input_shape, anchors, num_classes, load_pretrained=False, freeze_body=2,
    ...
    model_body = yolo_19_body(image_input, num_anchors//2, num_classes)
